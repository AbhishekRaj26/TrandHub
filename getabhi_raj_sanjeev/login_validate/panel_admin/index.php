          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="index.php"><i class="fa fa-circle-o"></i> Dashboard Enquiry System</a></li>
          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                <div class="inner">
                  <?php include 'script/countenquiry.php'; ?>
            ...
            <section class="col-lg-7 connectedSortable">
              ...
              <div class="box box-success">
                <div class="box-header">
                  ...
                  <h3 class="box-title">New Contact Enquiries</h3>
                  <?php include ('script/fetch_contact_message.php');?>
                ...
                <div class="box-body chat" id="chat-box">
                  <?php
                          ...
                          $sql22 = "SELECT * FROM `contact_enquiry`";
                            ...
                            while ($row = mysqli_fetch_array($result, MYSQLI_BOTH)) 
                            {
                              ...
                              ?>
                                ...
                                <div class="item">
                                  ...
                                  <p class="message">
                                    <a href="#" class="name">
                                      <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> <?php echo $email;?></small>
                                      <?php echo $name;?>
                                    </a>
                                    <?php echo $msg;?>
                                  </p>
