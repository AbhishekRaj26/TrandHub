		...
		<div class="account_grid">
			   <div class="col-md-12 login-right">
				...
				<form action="script/add_product.php" method="post" enctype="multipart/form-data">
					...
					<input type="text" name="product_name" placeholder="Enter Product Name" style="width: 500px;border-radius: 4px;">

					<span> <font size = "4" color="black"> Per unit price *</span>
					<input type="text" name="perunitprice" placeholder="Enter Per Unit Price" style="width: 500px;border-radius: 4px;">

					<span> <font size = "4" color="black"> Description *</span>
					<input type="text" name="desctiption" placeholder="Enter Product Details" style="width: 500px;height: 100px; border-radius: 4px"></font>

					<span> <font size = "4" color="black"> Maximum Order *</span>
					<input type="number" name="maxorder" placeholder="Maximum order that you can deliver" style="width: 400px; border-radius: 4px;" min="0"></font>

					<span> <font size = "4" color="black">Minimum Order *</span>
					<input type="number" name="minorder" placeholder="Minimum order that you deliver" required="" style="width: 400px; border-radius: 4px;" min="0"> </font>
					...
					<div class="word-in">
						<span><font size="3px">All the (*) feilds are required.</span></font>
						 <input type="submit" name="add_product" value="Add Product" style="background-color: #581845;
    																	border: none;
    																	color: white;
    																	border-radius: 10px;
    																	padding: 20px;
