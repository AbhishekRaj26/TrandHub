...
<html>
<head>
<title>Login to TrandHub, get more deals for your business | Login - TrandHub</title>
...
<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInLeft;">
				...
				<li class="active">Login as Buyer</li>
			</ol>
		</div>
	</div>
<div class="account">
	<div class="container">
		...
		<div class="account_grid">
			   <div class="col-md-6 login-right">
				<form action="script/login_buyer_script.php" method="post">
			    ...
			    <div class="col-md-6 login-left">
				 ...
				 <a class="acount-btn" href="register_buyer.php" style="background-color: #581845;
    																	border: none;
    																	color: white;
    																	border-radius: 10px;
    																	padding: 20px;
