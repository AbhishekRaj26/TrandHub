...
if($_POST["view"] != '')
{
    $update_query = "UPDATE `quotation` SET read_msg_rcv = 1 WHERE read_msg_rcv ='0' and uid_seller ='$uid_seller'";
...
$status_query = "SELECT * FROM `quotation` WHERE read_msg_rcv = 0 and uid_seller = '$uid_seller'";
