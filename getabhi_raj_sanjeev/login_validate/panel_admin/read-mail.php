...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin TrandHub | Dashboard - Read Emails</title>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <?php 
        $sql_read_mail = "SELECT * FROM `newsletter_emails` WHERE id = '$id'";
        $result_read_mail = mysqli_query($con, $sql_read_mail);
        if(mysqli_num_rows($result_read_mail) > 0)
        {
          while ($row_read_mail = mysqli_fetch_array($result_read_mail, MYSQLI_BOTH)) 
          {
            $subject_read_mail = $row_read_mail['subject'];
            $msg_read_mail = $row_read_mail['message'];
            $date_read_mail = $row_read_mail['date_time'];
          }
        }
        else
        {
          $err_msg = "Now Mail Found with this id";
        }
      ?>
              ...
              <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                  <div class="mailbox-read-info">
                    <h3>Message Subject - <?php echo $subject_read_mail?></h3>
                    <h5>From: info@trandhub.com <span class="mailbox-read-time pull-right"><?php echo $date_read_mail;?></span></h5>
