...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin TrandHub | Dashboard - Compose Email</title>
              ...
              <div class="box box-primary">
                ...
                <form action="emailsend.php" method="POST">
                  <div class="form-group">
                    <input class="form-control" placeholder="To:" value="Mail will be sent to all Subscribers Automatically." />
                  </div>
                  <div class="form-group">
                    <input class="form-control" name="subject" placeholder="Subject:" required="" />
                  </div>
                  <div class="form-group">
                    <textarea id="compose-textarea" class="form-control" style="height: 300px" required="" name="message">
                    </textarea>
                  </div>
                </div><!-- /.box-body -->
