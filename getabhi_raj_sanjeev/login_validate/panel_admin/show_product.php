                  ...
                  <form action="script/addproduct.php?uid_supplier=<?php echo $uid_supplier;?>" method="POST">
                    <table id="example2" class="table table-bordered table-hover">
                      ...
                      <tr>
                        ...
                        <td><?php echo $quantity_per_unit;?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><?php echo $trandhub_charges;?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><?php echo $unit_in_order;?></td>
                      </tr>
                      <tr>
                        <td><b>Discount</b></td>
                        <td><?php echo $discount_pro;?></td>
                      </tr>
                      <?php
                      # Fetch image
                      ...
                      <tr>
                        <td><b>Images</b></td>
                        <td><img src="../../../<?php echo $link_img;?>" width="100px" ></td>
                      </tr>
                      <?php
                          }
                        } 
