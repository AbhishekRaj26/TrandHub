			...
			<div class="content-top1">
				...
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="view_product.php?uid_product=<?php echo $uid_product;?>">
							<?php 
						...
						<h3><a href="single.html"><?php echo $name_product;?></a></h3>
						<div class="price">
								<h5 class="item_price"><?php echo $description;?></h5>
								<a href="#" class="item_add">Get Qoutations</a>
								<div class="clearfix"> </div>
						</div>
					</div>
				</div>	
