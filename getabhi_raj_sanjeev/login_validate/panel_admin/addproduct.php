    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Add Products
            <small>Add products to <?php echo $store_name;?>.</small>
          </h1>
          <ol class="breadcrumb">
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                  <form action="script/addproduct.php?uid_supplier=<?php echo $uid_supplier;?>" method="POST">
                    <table id="example2" class="table table-bordered table-hover">
                      ...
                      <tr>
                        ...
                        <td><input type="text" name="description" required="" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
                        <td><b>Quantity Per Unit</b></td>
                        <td><input type="number" min="1" name="quantity_per_unit" required="" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
                        <td><b>Unit Price</b></td>
                        <td><input type="number" name="unitprice" required="" min="1" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
                        <td><b>TrandHub Charges</b></td>
                        <td><input type="number" name="trandhub_charges" required="" min="1" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
                        <td><b>Unit Weight (Gram)</b></td>
                        <td><input type="text" name="unit_weight" min="1" required="" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
                        <td><b>Unit in Stock</b></td>
                        <td><input type="number" name="unit_in_stock" min="1" required="" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
                        <td><b>Units in order</b></td>
                        <td><input type="number" name="unit_in_order" min="0" required="" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
                        <td><b>Discount</b></td>
                        <td><input type="number" min="1" name="discount" required="" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
