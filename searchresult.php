...
<html>
<head>
<title>Search Results | Search Results - TrandHub</title>
...
<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInLeft;">
				...
				<li class="active">Your Seach Results</li>
			</ol>
		</div>
	</div>
<!--content-->
<div class="products">
	<div class="container">
		...
		<div class="col-md-9">
			...
			<?php
				include('script/connection.php');
				$sql11 = "SELECT * FROM `products` WHERE uid_product = '$uid_product'";
			...
			<!--categories-->
				<div class=" rsidebar span_1_of_left">
						<!--<h3 class="cate">Apply Filters</h3>
							 <ul class="menu-drop">
							<li class="item1">Metal
							</li>
							<li class="item2">Wooden
							</li>
							<li class="item3">x
							</li>
							<li class="item4">y
							...
							<a href="apply_fliter.php"> <button style="background-color: #581845;
    																	border: none;
    																	color: white;
    																	border-radius: 10px;
    																	padding: 20px;
