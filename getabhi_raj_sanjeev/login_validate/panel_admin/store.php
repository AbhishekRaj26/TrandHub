    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Stores
            <small>All Register Stores</small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Stores Data Table</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php
                        $sql_fetch_store = "SELECT * FROM `company`";
                        $sr=0;
                        ...
                        if(mysqli_num_rows($result_fetch_store) > 0)
                        {
                          ...
                          {
                            $uid_store = $row_fetch_store['uid_company'];
                            $uid_owner = $row_fetch_store['uid_user'];
                            $name_store = $row_fetch_store['company_name'];
                            $street_store = $row_fetch_store['street'];
                            $city_store = $row_fetch_store['city'];
                            $state_store = $row_fetch_store['state'];
                            $country_store = $row_fetch_store['country'];
                            $zip_store = $row_fetch_store['zip'];
                            $logo = $row_fetch_store['logo'];
                            $sr++;
                      ...
                      <tr>
                        <td><?php echo $sr;?></td>
                        <td><?php echo $uid_store;?></td>
                        <td><?php echo $name_store;?></td>
                        <td><?php echo $fname." ".$lname;?></td>
                        <td><?php echo $phone_owner;?></td>
                        <td><?php echo $email_owner;?></td>
                        <td><?php echo $street_store." ".$city_store." ".$state_store." ".$country_store." ".$zip_store;?></td>
                        <td><img src="../script/<?php echo $logo;?>" width="70%" height="40%"></td>
                      </tr>
                      <?php
                          }
                        }
