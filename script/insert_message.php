<?php
	...
	if (isset($_POST['submit']))
	{
		...
		{
			$sql = "INSERT INTO `messages`(`uid_query`, `uid_product`, `uid_buyer`, `uid_seller`, `message_original`, `time`, `user_identify`) VALUES ('$uid_query', '$uid_product', '$uid_buyer', '$uid_seller', '$buyer_reply', now(), '0')";
