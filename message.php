...
<div class="container">
	...
	<h2>Messages</h2>
	<form action="script/insert_message.php?uid_query=<?php echo $uid_query;?>&&uid_product=<?php echo $uid_product; ?>&&uid_seller=<?php echo $uid_seller;?>&&uid_buyer=<?php echo $uid_buyer;?>" method="POST">
		...
		<div class="container211">
			<font size="1px" color="Grey"><?php echo $fname; echo " ";echo $lname; ?></font>
		...
		<div class="container211 darker211">
			<font size="1px" color="grey"><?php echo $seller_fname.' '.$seller_lname;?></font>
		  	<p><?php echo $message; ?></p>
