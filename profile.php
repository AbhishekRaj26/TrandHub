		...
		<div class="account_grid">
			   <div class="col-md-6 login-right">
				...
				<form action="script/complete_company_profile.php" method="post" enctype="multipart/form-data">
					...
					<span> <font size = "5"> Name *</span>
					<?php echo $fname; echo " ";  echo $lname; ?></font>

					<span> <font size = "4"> E-mail *</span>
					<?php echo $email ?></font>

					<span> <font size = "4"> Phone Number *</span>
					<?php echo $phone ?>

					<?php include('script/company_exist.php'); ?>
					
					<span>Company Name *</span>
					<input type="text" name="company_name" placeholder="Your Business Name" value="<?php echo $company_name; ?>" required=""> </font>
			   </div>	
			    <div class="col-md-6 login-left">
					<span> <font size = "5"> Registered Address </span><br/>
					<span> <font size = "4"> Street *</span><br/>
					<input type="text" name="street" placeholder="Street" value="<?php echo $street; ?>" required=""><br/>
					...
					<input type="text" name="state" placeholder="State" value="<?php echo $state; ?>" required=""><br/>

					<span> <font size = "4"> Country *</span><br/>
					<input type="text" name="country" placeholder="Country" value="<?php echo $country; ?>" required=""><br/>

					<span> <font size = "4"> Zip Code *</span><br/>
					<input type="text" name="zip" placeholder="Zip Code" value="<?php echo $zip ?>" required=""><br/>
