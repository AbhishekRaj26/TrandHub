...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin TrandHub | Dashboard - Seller</title>
    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="data.php"><i class="fa fa-circle-o"></i> Sellers</a></li>
              </ul>
            </li>
            <li>
              <a href="calendar.php">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-folder"></i> <span>Enquiries</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Sellers
            <small>All Register Sellers</small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Seller Data Table</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php
                        $sql_fetch_seller = "SELECT * FROM `sign up`";
                        $sr=0;
                        ...
                        if(mysqli_num_rows($result_fetch_seller) > 0)
                        {
                          ...
                          {
                            $fname_seller = $row_fetch_seller['fname'];
                            $lname_seller = $row_fetch_seller['lname'];
                            $uid_seller = $row_fetch_seller['uid'];
                            $email_seller = $row_fetch_seller['email'];
                            $phone_seller = $row_fetch_seller['Phone'];
                            $sr++;

                            $sql_fetch_store = "SELECT * FROM `company` WHERE uid_user = '$uid_seller'";
                            ...
                            if(mysqli_num_rows($result_fetch_store) > 0)
                            {
                              ...
                              {
                                $cname = $row_fetch_store['company_name'];
                              }
                            }
                      ...
                      <tr>
                        <td><?php echo $sr;?></td>
                        <td><?php echo $uid_seller;?></td>
                        <td><?php echo $fname_seller." ".$lname_seller;?></td>
