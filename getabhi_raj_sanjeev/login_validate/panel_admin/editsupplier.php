    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Edit Supplier
            <small>Edit supplier Information.</small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  ?>
                  <form action="script/editsupplier.php?uid_supplier=<?php echo $uid_supplier;?>" method="POST">
                    <table id="example2" class="table table-bordered table-hover">
                      <tr>
                        <td><b>Name</b></td>
                        <td><input type="text" name="name" value="<?php echo $name_supplier;?>" required="" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
                        <td><b>Email</b></td>
                        <td><input type="email" name="email" value="<?php echo $email_supplier;?>" required="" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
                        <td><b>Phone</b></td>
                        <td><input type="number" min="1" name="number" value="<?php echo $phone_supplier;?>" required="" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
                        <td><b>Store Name</b></td>
                        <td><input type="text" name="store_name" value="<?php echo $store_name;?>" required="" min="1" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
                        <td><b>Address</b></td>
                        <td><textarea style="width: 80%; border-radius: 20px" name="address"><?php echo $address_supplier;?></textarea></td>
                      </tr>
                      <tr>
                        <td><b>City</b></td>
                        <td><input type="text" name="city" value="<?php echo $city_supplier;?>" min="1" required="" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
                        <td><b>State</b></td>
                        <td><input type="text" name="state" value="<?php echo $state_supplier;?>" required="" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
                        <td><b>Country</b></td>
                        <td><input type="text" name="country" value="<?php echo $country_supplier;?>" required="" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
                        <td><b>Zip Code</b></td>
                        <td><input type="number" min="1" name="zip" value="<?php echo $zip_supplier;?>" required="" style="width: 80%; border-radius: 20px"></td>
                      </tr>
                      <tr>
                        <td colspan="2"><input type="submit" name="submit" value="Edit Supplier"></td>
                      </tr> 
                    </table>
                  </form>
                </div><!-- /.box-body -->
