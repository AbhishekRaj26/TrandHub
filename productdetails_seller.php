						...
						<div class="single-para simpleCart_shelfItem">
							...
							<div class="available">
								...
								<a href="editproduct.php?uid_product=<?php echo $uid_product; ?>"><button style="background-color: #581845;
    																	...
    																	font-size: 16px;
    																	margin: 4px 2px ">Edit product details</button></a>
    							<form action="script/upload_image.php?uid_product=<?php echo $uid_product?>" method="POST" enctype="multipart/form-data">
    								<font size="6">Upload Product Images</font><input type="file" value="Upload Image"  name="imageupload" required="" />
    								<input type="submit" name="submit" value="Upload Image" style="background-color: #581845;
    																	border: none;
    																	color: white;
    																	border-radius: 10px;
    																	padding: 20px;
