<?php
	if (isset($_GET['uid']) && isset($_GET['tmp_pass']))
	{
?>
<!DOCTYPE html>
<html>
<head>
<title>Forget Password to TrandHub, get more deals for your business | Login - TrandHub</title>
	...
	<div class="container">
		...
		<div class="account_grid">
			   <div class="col-md-12" style="text-align: center; display: inline-block;">
				<form action="script/changepassword.php?uid=<?php echo $_GET['uid'];?>&&tmp_pass=<?php echo $_GET['tmp_pass'];?>" method="post">

					<span>Enter New Password</span>
					<input type="password" name="password" required="" placeholder="Enter new password"><br/><br/>

					<span>Confirm New Password</span>
					<input type="password" name="cpass" required="" placeholder="Enter password"> 
					<div class="word-in">
				  		<a class="forgot" href="forgetpassword.php">Forgot Your Password?</a>
				 		 <input type="submit" value="Change Password" name="submit" style="background-color: #581845;
    																	border: none;
    																	color: white;
    																	border-radius: 10px;
    																	padding: 20px;
...
<?php
	...
	{
		$msg = "Please try to reset your password. For security reasons.";
